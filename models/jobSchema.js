...
const jobSchema = new mongoose.Schema({
    title:{
        ...
        maxLegth: [50, "Job title cannot exceed 50 characters!"],
    },
    description:{
        type: String,
        required: [true, "Please provide job description"],
        minLength: [50, "Job description must contain at least 50 characters!"],
        maxLegth: [350, "Job description  cannot exceed 350 characters!"],
    },
    category:{
        type: String,
    ...
    fixedSalary:{
        ...
        maxLegth: [9, "Fixed salary cannot exceed 9 digits!"],
    },
    salaryFrom:{
        type: Number,
        minLength:[4, "Fixed salary must contain at least 4 digits!"],
